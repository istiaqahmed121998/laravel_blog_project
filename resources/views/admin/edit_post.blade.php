        ...
        <form id="blogpost" method="POST" action="{{ route('blog.store') }}">
            ...
            <div class="card card-custom example example-compact">
                ...
                <div class="card-header">
                    <h3 class="card-title"><div id='id' style="padding-right: 5px;">{{$blog->id}} </div>  Edit YOUR BLOG</h3>
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control form-control-lg" placeholder="Title" value="{{$blog->title}}" readonly/>
                    </div>
                    <div class="form-group row">
                        <label class="col-form-label text-left col-lg-3 col-sm-12">{{route('blog.post')}}/</label>
                        <div class="col-lg-8 col-md-9 col-sm-12">
                            <input type="text" class="form-control money" id="slug" name="slug" value="{{$blog->slug}}" readonly>
                        </div>
                    </div>
                    <div class="form-group">
