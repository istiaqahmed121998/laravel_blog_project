                        ...
                        <table class="table table-head-custom table-vertical-center table-head-bg table-borderless">
                            <thead>
                                <tr class="text-left">
                                    ...
                                    <th style="min-width: 120px">Total Post</th>
                                    <th style="min-width: 100px">Total View</th>
                                    <th style="min-width: 100px">Total Comment</th>
                            ...
                            @if($user->role->name==="Admin" || $user->role->name==="Author")
                                <tr>
                                    <td class="pl-0 py-8">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div>
                                                ...
                                                <span class="text-muted font-weight-bold d-block">{{$user->role->name}}</span>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="text-dark-75 font-weight-bolder d-block font-size-lg">{{$user->profile->posts->sum('views')}}</span>
                                        <span class="text-muted font-weight-bold">Views</span>
                                    </td>
                                    <td>
