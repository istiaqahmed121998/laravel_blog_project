                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item menu-item-submenu {{ Request::is('panel/create-post') || Request::is('admin/bloglist') || Request::is('admin/category') || Request::is('panel/postlist') ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">Post Infomation</span>
                        ...
                        @admin
                        <li class="menu-item menu-item-submenu {{ Request::is('admin/userlist') ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                            ...
                            <div class="menu-submenu">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ Request::is('admin/userlist') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                        ...
                        @admin
                        <li class="menu-item menu-item-submenu {{ Request::is('panel/comments')  ? 'menu-item-open menu-item-here' : '' }}" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="javascript:;" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Bucket.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                ...
                                <ul class="menu-subnav">
                                    ...
                                    <li class="menu-item {{ Request::is('admin/category') ? 'menu-item-active' : '' }}" aria-haspopup="true">
                                        <a href="{{route('comments.index')}}" class="menu-link">
                                            ...
                                            <span class="menu-text">Comments List</span>
                                        </a>
                                    </li>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                ...
                                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">{{explode(' ',trim(auth()->user()->name))[0]}}</span>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span id="user_email" class="navi-text text-muted text-hover-primary">{{auth()->user()->email}}</span>
                        </span>
                    </a>
