...
<div class="login-form login-signin">
    ...
    <form class="form" novalidate="novalidate" id="kt_login_signin_form" method="POST" action="{{ route('login') }}">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('email') is-invalid @enderror" type="email" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            @error('email')
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg @error('email') is-invalid @enderror" type="password" name="password" required autocomplete="current-password">
            @error('email')
            <div class="invalid-feedback">{{$message}}</div>
            @enderror
        </div>
        ...
        <div class="pb-lg-0 pb-5">
            ...
            <a href="{{route('login.google')}}" type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                ...
                <a href="{{route('login.discord')}}" type="button" class="btn btn-light-primary font-weight-bolder px-8 py-4 my-3 font-size-lg">
                <i class="socicon-discord text-primary mr-5"></i>With Discord</a>
        </div>
        <!--end::Action-->
    </form>
    <!--end::Form-->
