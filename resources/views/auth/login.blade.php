    ...
    <div class="login-form login-signin">
        ...
        <!--begin::Title-->
            ...
            <div class="form-group">
                ...
                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
            </div>
            <!--end::Form group-->
            <!--begin::Form group-->
            <div class="form-group">
                ...
                <input class="form-control form-control-solid h-auto py-6 px-6 rounded-lg" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
            </div>
            <!--end::Form group-->
            <!--begin::Action-->
